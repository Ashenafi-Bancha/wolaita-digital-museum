...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.visitDesc': 'Journey through over 500 years of royal heritage. From Kawo Motolomi to Kawo Tona Gaga, discover the legendary monarchs who shaped a great civilization.',
    ...
    'home.featuredKing': '⭐ Featured: Kawo Tona Gaga',
  ...
  wo: {
    ...
    'home.visitDesc': '500+ laatta kaawa laammaa ogiyaa. Kawo Motoloomippe Kawo Tona Gagaassi gakkanaassi gitataa aadaa ooyssida kawoota erettite.',
    ...
    'home.featuredKing': '⭐ Kawo Tona Gaga',
  ...
  am: {
    ...
    'home.visitDesc': 'ከ500 ዓመታት በላይ ንጉሳዊ ቅርስ ጉዞ። ከካዎ ሞቶሎሚ እስከ ካዎ ቶና ጋጋ ድረስ ታላቅ ሥልጣኔ የገነቡ ታዋቂ ነገስታትን ያግኙ።',
